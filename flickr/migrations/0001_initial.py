    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flickr_id', models.CharField(unique=True, max_length=50, db_index=True)),
                ('show', models.BooleanField(default=True)),
                ('last_sync', models.DateTimeField(null=True, editable=False, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_file', models.FileField(null=True, upload_to=flickr.models.upload_path, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(null=True, blank=True)),
                ('date_updated', models.DateTimeField(null=True, blank=True)),
                ('photos', models.ManyToManyField(to='flickr.Photo', null=True, blank=True)),
                ('user', models.ForeignKey(to='flickr.FlickrUser')),
            ],
            options={
