...
FLICKR_PHOTO_URL_PAGE_SIZES = (
    "http://www.flickr.com/photos/%(user-id)s/%(photo-id)s/sizes/%(size-suffix)s/"
)
...
FLICKR_BUDDY_ICON = (
    "http://farm%(icon-farm)s.staticflickr.com/%(icon-server)s/buddyicons/%(nsid)s.jpg"
)
...
FLICKR_PHOTO_SIZES = {
    ...
    "Medium": {"label": "medium", "longest": 500, "url_suffix": "m"},
    "Medium 640": {
        "label": "medium640",
        "longest": 640,
        "source_suffix": "z",
    ...
    "Medium 800": {"label": "medium800", "longest": 800, "source_suffix": "c"},
    "Large": {
        "label": "large",
        "longest": 1024,
        "source_suffix": "b",
